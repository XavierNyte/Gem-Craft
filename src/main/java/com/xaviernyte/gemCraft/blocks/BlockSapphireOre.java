...
public class BlockSapphireOre extends Block {
	...
	public BlockSapphireOre() {
		super(Material.ROCK);
		setUnlocalizedName(Reference.TutorialBlocks.SAPPHIRE_ORE.getUnlocalizedName());
		setRegistryName(Reference.TutorialBlocks.SAPPHIRE_ORE.getRegistryName());
		setHardness(3.0F);
		setResistance(15.0F);
    ...
    // Drop some experience when sapphire is mined
    @Override

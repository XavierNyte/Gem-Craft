...
public class BlockRubyOre extends Block {
	...
	public BlockRubyOre() {
		super(Material.ROCK);
		setUnlocalizedName(Reference.TutorialBlocks.RUBY_ORE.getUnlocalizedName());
		setRegistryName(Reference.TutorialBlocks.RUBY_ORE.getRegistryName());
		setHardness(3.0F);
		setResistance(15.0F);
    ...
    // Drop some experience when rubies are mined
    @Override
